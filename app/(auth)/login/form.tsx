                ...
                <div className="grid gap-2">
                    ...
                    <div className="relative">
                        ...
                        <Button
                            ...
                            {state.showPassword ? <EyeIcon className="w-5 h-5" /> : <EyeClosedIcon className="w-5 h-5" />}
                            <span className="sr-only">Show password</span>
                        </Button>
                    </div>
                </div>
                <div className="flex items-center space-x-2">
                    <Checkbox id="terms" checked={state.terms} onCheckedChange={() => setState({ ...state, terms: !state.terms })} />
                    <Label htmlFor="terms">
                        I accept the{" "}
                        <Link
                            href="#"
